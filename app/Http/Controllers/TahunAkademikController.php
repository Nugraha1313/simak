...
class TahunAkademikController extends Controller
{
    ...
    public function store(TahunAkademikRequest $request)
    {
        ...
        return redirect()->route('tahun-akademik.index')->with('success', 'Data Tahun Akademik Berhasil Ditambahkan!');
    }
    ...
    public function update(TahunAkademikRequest $request, $id)
    {
        ...
        return redirect()->route('tahun-akademik.index')->with('success', 'Data Tahun Akademik Berhasil Diubah!');
    }

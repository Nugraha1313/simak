            ...
            <div class="card mb-4 border-0 bg-secondary" style="border-radius: 20px;">
              ...
              <div class="card-body px-2 pt-0 pb-2">
                <div class="p-4 bg-secondary">
                  <form action="{{ route('updateProfile.dosen') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" name="nip_dosen" value="{{ $item->nip_dosen }}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" name="prodi_dosen" value="{{ $item->prodi_dosen }}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="email_dosen" class="form-control form-control-alternative" name="email_dosen" value="{{ $item->email_dosen }}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row mb-3">
                      <div class="col-sm-10 ">
                        <a href="{{ route('profile.dosen') }}" class="btn btn-success pull-left">

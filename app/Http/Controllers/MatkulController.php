...
class MatkulController extends Controller
{
    ...
    public function store(MatkulRequest $request)
    {
        ...
        return redirect()->route('mata-kuliah.index')->with('status', 'Data berhasil ditambahkan!');
    }
    ...
    public function update(MatkulRequest $request, $id)
    {
        ...
        return redirect()->route('mata-kuliah.index')->with('status', 'Data berhasil diubah!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('mata-kuliah.index')->with('status', 'Data berhasil dihapus!');
    }
}

<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white" id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      {{-- DASHBOARD --}}
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('administrator') ? 'active' : '') }}" href="{{ route('administrator') }}">
      ...
      {{-- KURIKULUM --}}
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('administrator/kurikulum') ? 'active' : '') }}" href="{{ route('kurikulum.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      {{-- DATA DOSEN --}}
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('administrator/dosen') ? 'active' : '') }}" href="{{ route('dosen.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      {{-- DATA MAHASISWA --}}
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('administrator/mahasiswa') ? 'active' : '') }}" href="{{ route('mahasiswa.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      {{-- TAHUN AKADEMIK --}}
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('administrator/tahun-akademik') ? 'active' : '') }}" href="{{ route('tahun-akademik.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      {{-- MATA KULIAH --}}
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('administrator/mata-kuliah') ? 'active' : '') }}" href="{{ route('mata-kuliah.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      {{-- RUANGAN --}}
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('administrator/ruangan') ? 'active' : '') }}" href="{{ route('ruangan.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">

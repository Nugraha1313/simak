...
<body class="g-sidenav-show bg-gray-100">
  ...
  <!--   Core JS Files   -->
  <script src="  {{asset('public/dashboard/js/core/popper.min.js')}} "></script>
  <script src="  {{asset('public/dashboard/js/core/bootstrap.min.js')}} "></script>
  <script src="  {{asset('public/dashboard/js/plugins/perfect-scrollbar.min.js')}} "></script>
  <script src="  {{asset('public/dashboard/js/plugins/smooth-scrollbar.min.js')}} "></script>
  <script>

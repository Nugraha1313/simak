                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('fk_matkul_jadwal') is-invalid @enderror" id="exampleFormControlSelect1" name="fk_matkul_jadwal">
                              ...
                              @foreach ($matkul as $item)
                                <option value="{{ $item->id }}">{{$item->kode_matkul}} | {{ $item->nama_matkul }} | {{$item->sks_matkul}} SKS</option>
                              @endforeach
                            </select>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" name="waktu_jadwal" value="{{ old('waktu_jadwal') }}" 
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('fk_ruangan_jadwal') is-invalid @enderror" id="exampleFormControlSelect1" name="fk_ruangan_jadwal">
                              ...
                              @foreach ($ruangan as $item)
                                <option value="{{ $item->id }}">{{ $item->kode_ruangan }}</option>
                              @endforeach
                            </select>

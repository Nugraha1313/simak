                    ...
                    <div class="row">
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" name="kode_matkul" value="{{ old('kode_matkul') }}" 
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" name="nama_matkul" value="{{ old('nama_matkul') }}" 
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" name="sks_matkul" value="{{ old('sks_matkul') }}" 

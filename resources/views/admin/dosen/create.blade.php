        ...
        <div class="col-12">
            <div class="card mb-4 border-0 bg-secondary" style="border-radius: 20px;">
              <div class="card-header border-0 pb-0" style="border-radius: 20px;">
                <h4>Create Data Dosen/Tendik</h4>
              </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" name="nip_dosen" value="{{ old('nip_dosen') }}" 
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" name="nama_dosen" value="{{ old('nama_dosen') }}" 
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" name="tmp_dosen" value="{{ old('tmp_dosen') }}" 
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control form-control-alternative" name="tgl_dosen" value="{{ old('tgl_dosen') }}" 
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" name="alamat_dosen"value="{{ old('alamat_dosen') }}" 
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" name="prodi_dosen"value="{{ old('prodi_dosen') }}" 
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" name="agama_dosen" value="{{ old('agama_dosen') }}" 
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-alternative" name="telp_dosen" value="{{ old('telp_dosen') }}" 
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="email_dosen" class="form-control form-control-alternative" name="email_dosen" value="{{ old('email_dosen') }}" 
                      ...
                      <div class="col-md-6 jk">
                        <div class="form-group">
                          ...
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="gender_dosen" id="inlineRadio1" value="Laki-laki">
                            <label class="custom-control-label" for="inlineRadio1">Laki-laki</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="gender_dosen" id="inlineRadio2" value="Perempuan">
